...
function createSenderRow(sender) {
    ...
    typeBadge.className = 'badge sender-type';
    typeBadge.textContent = getLogTypeName(sender.log_type);
    ...
    statusBadge.className = `badge sender-status ${sender.enabled ? 'enabled' : 'disabled'}`;
    ...
    toggleBtn.textContent = sender.enabled ? '⏸️' : '▶️';
