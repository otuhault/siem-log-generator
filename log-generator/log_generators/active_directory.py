...
class ActiveDirectoryLogGenerator(AIEntityMixin):
    ...
    def _user_account_fields(self, target_user=None):
        ...
        user = target_user or self._ai_user('target_users', self.target_users)
        domain = random.choice(self.domains)
...
{target}
    ...
    def _generate_4781(self):
        ...
        old_name = self._ai_user('target_users', self.target_users)
...
{self._subject_block()}
    ...
    def _group_membership_event(self, event_id):
        ...
        member = self._ai_user('target_users', self.target_users)
...
{self._subject_block()}
    ...
    def _generate_5136(self):
        ...
        target_user = self._ai_user('target_users', self.target_users)
...
{self._subject_block()}
    ...
    def _generate_5137(self):
        ...
        target = self._ai_user('target_users', self.target_users)
        domain_dns = random.choice(self.domain_dns)
...
{self._system_block(4769, 14337)}
  <EventData>
    ...
    def _generate_4771(self):
        ...
        user = self._ai_user('target_users', self.target_users)
        domain = random.choice(self.domain_dns)
...
{self._subject_block()}
    ...
    def generate(self):
        ...
        # Indented templates in, the form Windows ships out — see windows_xml.py.
        return render_windows_xml(selected())
